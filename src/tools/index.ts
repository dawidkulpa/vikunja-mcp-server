...
import { registerTaskActivityTool } from './task-activity';
import { registerTaskMoveTool } from './task-move';
...
export { registerTaskActivityTool } from './task-activity';
export { registerTaskMoveTool } from './task-move';
...
export function registerTools(
  ...
  registerTaskActivityTool(server, authManager, clientFactory);
  registerTaskMoveTool(server, authManager, clientFactory);
